            ...
            <div class="carousel-item ">
              <div class="container-fluid pr-0 pl-0">
                <div class="row">
                  <div class="col-md-12 ">
                    <div class="img-box">
                      <img src="user/images/slider3.jpg" alt="" />
                    </div>
                  </div>
                </div>
              </div>
...
for (int i = 0; i < productTypeIds.length; i++) {
    int typeId = productTypeIds[i];
    String typeName = productTypeNames[i];
    List<ProductBean> productsByType = prodDao.getAllProductsByTypeLimitFour(typeId);
...
%>
  <section class="shop_section layout_padding">
    <div class="container">
          ...
          <div class="box">
            <a href="">
              ...
              <form method="post">
				...
				%>
				<button type="submit"
					formaction="./AddtoCart?uid=<%=userName%>&pid=<%=product.getProdId()%>&pqty=1&type=<%=product.getProdType()%>&page=2"
				...
				%>
				<button type="submit"
					formaction="./AddtoCart?uid=<%=userName%>&pid=<%=product.getProdId()%>&pqty=0&type=<%=product.getProdType()%>&page=2"
      ...
      <div class="btn-box">
        <a href="userHome.jsp?type=<%= typeId %>">
          View More
        </a>
      </div>
    </div>
